...
class GestItem : public QGraphicsItem
{
...
public:
	...
	GestItem(qreal x1, qreal y1, qreal x2, qreal y2, QGraphicsItem *parent = 0);
	...
	virtual void intersectPorts(GestItem *connectingItem);
...
protected:
	...
	void findDocPoint(GestItem *connectingItem);
